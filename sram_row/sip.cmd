...
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt5 -b mt2,mt1,poly,diff,sti 	-t mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt3:mt3_cut,key,mt5,key 0,2.1,0 - 	mt3_mt5.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt2,mt1,poly,diff,sti -t 	mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt3:mt3_cut,key,mt4,key 0,2.1,0 - 	mt3_mt4.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt4 -b mt1,poly,diff,sti -t 	mt5,mt6,mt7,mt8,mt9 -k mt3:0.36 -Maxw 2.1 -p mt2:mt2_cut,key,mt4,key 	0,2.1,0 - mt2_mt4.sip
