#!/bin/ksh
# This script was generated Sat Oct 20 15:07:15 2012 by:
#
# Program: /usr/local/cadence/Assura0320001/tools/assura/bin/32bit/RCXspice
# Version: 3.1.5
# Created: Wed Dec 8 11:40:37 EST 2004
#
#/usr/local/cadence/Assura0320001/tools/assura/bin/32bit/RCXspice -techdir \
#	/home/ff/ee141/gpdk090_v3.9/assura/rcx -newlvs \
#	/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row.xcn \
#	-assura_run_dir /home/cc/ee141/fa12/class/ee141-aj/ee141_proj/ \
#	-assura_run_name sram_row -rcxdir \
#	/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row \
#	-xy_coordinates c,r -type full -temperature 25.0 -sub_node_char # \
#	-res_models no -rcxfs_type none -parasitic_res_models no \
#	-parasitic_cap_models no -output_net_name_space layout -output \
#	/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row/extview.tmp \
#	-net_name_space schematic -minR 0.001 -max_merged_via_size auto \
#	-max_fracture_length infinite -macro_cell -hierarchy_delimiter / \
#	-fracture_length_units microns -df2 -cap_models no -cap_ground GND! \
#	-cap_extract_mode decoupled -cap_coupling_factor 1.0 \
#	-array_vias_spacing auto -extract both -xref \
#	/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row.gnx,/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row.gdx
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##NETS_FILE=/dev/null
##OUTPUT=/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row
##RCXFS_HIGH=N
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row.gnx,/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row.gdx
##XY_COORDINATES=c,r
##=======================================================
...
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row
...
vdbToRcx /home/cc/ee141/fa12/class/ee141-aj/ee141_proj sram_row -unit meters \
	-- -V1 -H satfile -r \
	/home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row.xcn -df2 -xgl
...
geom -V Metal3_v Metal3_p metal3_conn - Metal3_v,111,i,2
geom -V via2_out_capInd metal3_conn metal2_conn - via2_out_capInd,111,i,2
geom -V Metal2_v Metal2_p metal2_conn - Metal2_v,111,i,2
...
flattenLayers -m metal3_conn metal2_conn metal1_conn poly_conn ndiff_conn \
	pdiff_conn nwell_conn psubstrate Metal3_v Metal3_p via2_out_capInd \
	Metal2_v Metal2_p Via1 Metal1_v Metal1_p cont_poly cont_pdiff \
...
GND!
ENDCAT
sch2lay -a -r /home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row.gnx -rd /home/cc/ee141/fa12/class/ee141-aj/ee141_proj/sram_row.gdx sch_cap_ground lay_cap_ground
...
selectNetsByNumber power_list_nums Metal2_p p_rMetal2_p np_rMetal2_p
selectNetsByNumber power_list_nums Metal3_p p_rMetal3_p np_rMetal3_p
...
mergevia -V -cnt np_rVia1 rVia1 - np_rmetal2_conn np_rmetal1_conn
mergevia -V -cnt np_rcont_poly rcont_poly - np_rmetal1_conn np_rpoly_conn
mergevia -V -cnt np_rvia2_out_capInd rvia2_out_capInd - np_rmetal3_conn \
	np_rmetal2_conn
...
flatlabel -V -tc -F Metal3_p_pintext Metal3_p_pintext_nr_labs
flatlabel -V -tc -F Metal2_p_pintext Metal2_p_pintext_nr_labs
...
connect -V -relocate NET np_rMetal1_p:np_rMetal1_p.conn \
	np_rMetal2_p:np_rMetal2_p.conn np_rMetal3_p:np_rMetal3_p.conn \
	...
	rvia2_out_capInd _nmos_12_MOS_1_mgvia _pmos_12_MOS_7_mgvia - \
	ntap_ndiff_conn_ovia,8,6 nwell_conn_ntap_ovia,4,8 \
	psubstrate_ptap_ovia,5,9 ptap_pdiff_conn_ovia,9,7 - \
	Metal3_p_pintext_nr_labs,3 Metal2_p_pintext_nr_labs,2 \
...
geom -V Metal2_v np_rMetal2_p.conn - tmp_rMetal2_v,11,i,2
mergevia -V -i -cnt tmp_rMetal2_v rMetal2_v - np_rmetal2_conn np_rMetal2_p
/bin/rm -f tmp_rMetal2_v
geom -V Metal3_v np_rMetal3_p.conn - tmp_rMetal3_v,11,i,2
mergevia -V -i -cnt tmp_rMetal3_v rMetal3_v - np_rmetal3_conn np_rMetal3_p
/bin/rm -f tmp_rMetal3_v
...
epick -V -reo -e rMetal1_v -e rMetal2_v -e rMetal3_v -e rcont_ndiff -e \
	rcont_pdiff np_rndiff_conn.conn tmp_ndiff_conn
...
epick -V -reo -e rMetal1_v -e rMetal2_v -e rMetal3_v -e rcont_ndiff -e \
	rcont_pdiff np_rpdiff_conn.conn tmp_pdiff_conn
...
epick -V -reo -e rMetal1_v -e rMetal2_v -e rMetal3_v -e rcont_ndiff -e \
	rcont_pdiff np_rnwell_conn.conn tmp_nwell_conn
...
epick -V -reo -e rMetal1_v -e rMetal2_v -e rMetal3_v -e rcont_ndiff -e \
	rcont_pdiff np_rpsubstrate.conn tmp_psubstrate
...
flatlabel -V  -tc -F Metal3_p_pintext,Metal2_p_pintext,Metal1_p_pintext L1T0,L2T0,L3T0
...
rex -V -m -pd -I'#' -u -N NET -e2 -Ply np_rpoly_conn -rP res.mod \
	...
	np_rmetal2_conn::mt2_cut np_rmetal3_conn::mt3_cut - rMetal1_v,2 \
	rMetal2_v,3 rMetal3_v,4 rVia1,2,3,t rcont_ndiff,2,t rcont_pdiff,2,t \
	rcont_poly,1,2,t rvia2_out_capInd,3,4,t _nmos_12_MOS_1_mgvia,1,z \
	_pmos_12_MOS_7_mgvia,1,z - L1T0,4,I L2T0,3,I L3T0,2,I
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt5 -b mt2,mt1,poly,diff,sti \
	-t mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt3:mt3_cut,key,mt5,key 0,2.1,0 - \
	mt3_mt5.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b mt2,mt1,poly,diff,sti -t \
	mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt3:mt3_cut,key,mt4,key 0,2.1,0 - \
	mt3_mt4.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt4 -b mt1,poly,diff,sti -t \
	mt5,mt6,mt7,mt8,mt9 -k mt3:0.36 -Maxw 2.1 -p mt2:mt2_cut,key,mt4,key \
	0,2.1,0 - mt2_mt4.sip
...
pax16 -V -scf sip.cmd -cgnd ${CAP_GROUND},1.0 -rP \
	np_rmetal3_conn.res,np_rmetal2_conn.res,np_rmetal1_conn.res,np_rpoly_conn.res,mwires.res \
	-M_perim_off -c /home/ff/ee141/gpdk090_v3.9/assura/rcx/cap_coeff.dat \
	-f sti diff poly:poly_cut mt1:mt1_cut mt2:mt2_cut mt3:mt3_cut mt4 mt5 \
	mt6 mt7 mt8 mt9 allGate - \
	/home/ff/ee141/gpdk090_v3.9/assura/rcx/paxfile_coeff - - NET - \
	capfile
...
xreduce -V -mergecap -n NET -d1 -e \
	...
	-minR 0.001 -rP \
	np_rmetal3_conn.res,np_rmetal2_conn.res,np_rmetal1_conn.res,np_rpoly_conn.res,mwires.res \
	-cap capfile L1T0 L2T0 L3T0 _nmos_12_MOS_1.transr \
...
advgen -V -g0 -li -f -n -o HSPICE -h ${HIERARCHY_DELIMITER} -TL \
	L1T0,L2T0,L3T0 -cgnd ${CAP_GROUND},1.0 -sc caps2dversion -mx capfile \
	mt9,mt8,mt7,mt6,mt5,mt4,mt3,mt2,mt1,poly,diff,sti -rP res.mod \
	...
	np_rpoly_conn.res,Rnp_rpoly_conn.dev2 -rP mwires.mod \
...
Metal3_v rMetal3_v
Metal3_p np_rMetal3_p p_rMetal3_p
via2_out_capInd rvia2_out_capInd np_rvia2_out_capInd p_rvia2_out_capInd
Metal2_v rMetal2_v
Metal2_p np_rMetal2_p p_rMetal2_p
Via1 rVia1 np_rVia1 p_rVia1
Metal1_v rMetal1_v
